...
### 1. 「分けた」と言いながら、分けたかを誰も確かめていない — 結果: 該当した
...
### 2. 検査が、いちばん大きい画面ファイルを見ていない — 結果: 該当した
...
### 4. 検査が、赤くなるところを一度も見ていない — 結果: 該当した
...
### 7. 分けたのではなく、片方を消してしまっている — 結果: 該当した
...
### 10. まっさらな環境では、検査そのものが失敗する — 結果: 該当した
